...
<table border="1" cellpadding="5" width="800">
	<tr>
		...
		<form action="book.php" method="post">
			...
			<p><input checked="checked" name="ServiceName" type="radio" value="<?php echo $row['ServiceName'];?> " /><?php echo $row['ServiceName'];?> 
		...
		$calendar.= '<td class="calendar-day">';
    		...
    		if (mysqli_num_rows($result) > 0) {
    			...
    			while($row = mysqli_fetch_assoc($result)) {
    				...
    				$calendar .= "<b>" . $row["ServiceName"] . "</b><br>ID: " . $row["id"] . "<br>" . $row["name"] . "<br>" . $row["phone"] . "<br>";
