        ...
        <div id="content">
          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <h2>Add New Service</h2><br/>
              <div>
                <form action="" method="post">
				  ...
				  <input type="button" class="btn btn-warning" value="Cancel" onClick="document.location.href='service.php';">
			...
			<?php
			  ...
			  $sql = "CALL insertservices('$ServiceName','$Description','$price')"; 
