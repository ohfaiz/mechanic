...
<?php
  ...
  $sql = "INSERT INTO admin(Username,  password, email, phone_number) 
...
<body>
    <div class="register" style="height:670px;" >
        <h2>Register</h2>
        <form method="post" action="" onSubmit="return checkInput()">
            ...
            <p>Phone Number</p>
            <input type="tel" name="phone_number" id="phone_number" placeholder="01********" >
            <p>Email</p>
            <input type="email" name="email" placeholder="xxxx@xxxx.com">
            <p>Password</p>
            ...
            <input type="button" value="Cancel" onClick="document.location.href='login.php';">
            </center>
        </form>
    </div>
